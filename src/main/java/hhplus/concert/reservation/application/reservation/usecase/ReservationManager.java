...
public class ReservationManager {
    ...
    @Transactional
    public void tryPaymentWithLock_OptimisticLock(long reservationId, long amount) {
    ...
    @Transactional
    public PaymentDTO PaymentCompleteWithLock_OptimisticLock(long customerId, long concertId, long reservationId, long amount) {
